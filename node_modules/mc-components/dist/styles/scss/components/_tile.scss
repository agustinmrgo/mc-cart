  ...
  &--gradient-bottom {
    background:
      -webkit-gradient(
        ...
        color-stop(0, rgba($mc-tile-overlay-color, 1)),
        color-stop(25%, rgba($mc-tile-overlay-color, 0.6)),
        color-stop(45%, rgba($mc-tile-overlay-color, 0))
      ) center no-repeat;
    background:
      linear-gradient(
        to top,
  ...
  &--spotlight {
    background:
      ...
      -webkit-gradient(
        linear,
        left top, right top,
        from(rgba($mc-color-background, 1)),
        color-stop(10%, rgba($mc-color-background, 0))
      ),
      -webkit-gradient(
        linear,
        right top, left top,
