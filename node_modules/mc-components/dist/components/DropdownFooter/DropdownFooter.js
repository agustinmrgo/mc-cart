...
function (_PureComponent) {
  _inherits(DropdownFooter, _PureComponent);

  function DropdownFooter() {
    _classCallCheck(this, DropdownFooter);

    return _possibleConstructorReturn(this, _getPrototypeOf(DropdownFooter).apply(this, arguments));
  }
...
exports["default"] = DropdownFooter;

_defineProperty(DropdownFooter, "propTypes", {
