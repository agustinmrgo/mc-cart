...
var _DropdownContentControlled = _interopRequireDefault(require("../DropdownContentControlled"));
...
function (_PureComponent) {
  _inherits(DropdownContent, _PureComponent);
  ...
  _createClass(DropdownContent, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_Dropdown.Consumer, null, function (_ref) {
        var show = _ref.show,
            toggle = _ref.toggle;
        return _react["default"].createElement(_DropdownContentControlled["default"], _extends({
          show: show,
          onClose: toggle
        }, _this.props));
      });
