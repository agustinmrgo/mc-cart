  ...
  _createClass(Badge, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["children", "className", "kind"]);

      var classNames = (0, _classnames["default"])((_cn = {
        'mc-badge mc-text-x-small': true
      }, _defineProperty(_cn, "mc-badge--".concat(kind), kind), _defineProperty(_cn, className, className), _cn));
...
_defineProperty(Badge, "propTypes", {
  ...
  kind: _propTypes["default"].oneOf(['default', 'dim', 'transparent', 'primary'])
});
