...
function (_PureComponent) {
  ...
  _createClass(TileCaption, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames["default"])((_cn = {}, _defineProperty(_cn, className, className), _defineProperty(_cn, 'mc-tile__component', true), _defineProperty(_cn, 'mc-tile-progress', true), _cn));
      return _react["default"].createElement("div", {
        className: classes
      }, _react["default"].createElement("div", {
        className: "mc-tile-progress__content"
      }, _react["default"].createElement("div", {
