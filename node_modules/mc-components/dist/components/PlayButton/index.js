...
function (_PureComponent) {
  ...
  _createClass(PlayButton, [{
    ...
    value: function render() {
      var className = (0, _classnames["default"])('mc-play-button', _defineProperty({}, this.props.className, !!this.props.className));
      return _react["default"].createElement("a", {
        className: className,
        onClick: this.onClick
      }, _react["default"].createElement(_PlayCircle["default"], {
