...
function (_PureComponent) {
  _inherits(DropdownBody, _PureComponent);

  function DropdownBody() {
    _classCallCheck(this, DropdownBody);

    return _possibleConstructorReturn(this, _getPrototypeOf(DropdownBody).apply(this, arguments));
  }
...
_defineProperty(DropdownBody, "propTypes", {
