...
function (_PureComponent) {
  ...
  function HoverHandler() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HoverHandler)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (state) {
      _this.setState(state);

      if (_this.props.onChange) _this.props.onChange(state);
    });

    _defineProperty(_assertThisInitialized(_this), "onEnter", function () {
      if (_this.timer) _this.timer = clearTimeout(_this.timer);
...
_defineProperty(HoverHandler, "propTypes", {
