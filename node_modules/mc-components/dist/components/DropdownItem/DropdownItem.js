...
function (_PureComponent) {
  ...
  function DropdownItem() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function (toggle) {
  ...
  _createClass(DropdownItem, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["children", "className", "closeOnClick", "onClick"]);
      ...
      return _react["default"].createElement(_Dropdown.Consumer, null, function (_ref) {
        ...
        return _react["default"].createElement("div", _extends({
          className: classes,
          onClick: _this2.handleClick(toggle)
        }, props), children);
      });
    }
  }]);
